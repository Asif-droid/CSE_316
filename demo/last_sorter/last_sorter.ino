...
ball balls[]={ball(1,2.5),ball(3,1.58),ball(2,1.45),ball(3,6.45),ball(1,6.53),ball(2,6.55)};
int ball_count;
...
int b=0;
 ...
 for(;pos1<90;pos1++){
  ...
  float i =balls[ball_count].getweight();
  delay(200);
  ///redColor <-117 && redColor> -232
  lcd.setCursor(0, 0);
  if(balls[ball_count].getcolor()==1){
      Serial.println(" - RED detected!");
      lcd.print("RED");
      deg= -60;
  }
  ///redColor <28 && redColor> -39
  else if(balls[ball_count].getcolor()==2){
